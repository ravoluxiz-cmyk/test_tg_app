    ...
    <ChessBackground>
      <div className="w-full max-w-2xl mx-auto px-4 sm:px-6 md:px-8 text-center">
        <div className="flex flex-col gap-6 items-center justify-center min-h-screen py-8">
          <h2 className="text-3xl sm:text-4xl font-black text-white">Запись на урок</h2>
          <p className="text-white/80 text-lg">
            Скоро здесь появится удобная запись на шахматные уроки. Следите за обновлениями!
          </p>
