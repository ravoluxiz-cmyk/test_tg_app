...
CREATE INDEX idx_rating_history_tournament_id ON rating_history(tournament_id);

-- Indexes for rating_periods
CREATE INDEX idx_rating_periods_tournament_id ON rating_periods(tournament_id);
CREATE INDEX idx_rating_periods_status ON rating_periods(status);
CREATE INDEX idx_rating_periods_dates ON rating_periods(start_date, end_date);

-- Indexes for tournament_rating_adjustments
CREATE INDEX idx_tournament_adjustments_tournament_id ON tournament_rating_adjustments(tournament_id);
CREATE INDEX idx_tournament_adjustments_user_id ON tournament_rating_adjustments(user_id);
